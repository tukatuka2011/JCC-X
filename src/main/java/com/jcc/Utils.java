...
public class Utils {
    ...
    /**
     *
     * pathShortener() and pathLengthShortene() getted from
    ...
    public static String pathShortener(String path) {
        return pathShortener(path, Utils.DEFAULT_SHORTENER_THRESHOLD);
    }
    ...
    /**
     * Compact a path into a given number of characters. Similar to the Win32
